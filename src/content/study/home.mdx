...
<Section id="1.00" title='Problem' hasBorder={false}>
  <Fragment slot="context">
    Wavy’s homepage made it **hard to find the events you care about**. It was a single calendar view with cells showing *events*, *notable days* and *suggested events*. These **items were undifferentiated**. At a glance, you couldn’t tell them apart. Events items themselves had no *status*, so you couldn’t tell which ones you’ve been invited to or already responded to. The month view made it difficult to see outside the current month. You’d forget all about events that 1-2 months away and go on scavenger hunts to find that event from 3 months ago. On top of that, may of the calendar’s colour themes weren’t accessible.
  </Fragment>
</Section>
    ...
    slides={[
      {
        ...
        alt: "Upcoming, mobile 1/2",
      },
      {
        id: "2.06",
        src: "/work/wavy/home/upcoming-mobile-2.png",
        alt: "Upcoming, mobile 2/2",
      },
      {
        id: "2.07",
      ...
      {
        id: "2.09",
        src: "/work/wavy/home/past-mobile-3.png",
        alt: "Past, mobile 3/3",
      },
      {
        id: "2.10",
