...
<Section id="1.00" title='Problem' hasBorder={false}>
  <p slot="context">Wavy’s homepage made it **hard to find the events you care about**. It was a single calendar view with cells showing *events*, *notable days* and *suggested events*. These **items were undifferentiated**. At a glance, you couldn’t tell them apart. Events items themselves had no *status*, so you couldn’t tell which ones you’ve been invited to or already responded to. The month view made it difficult to see outside the current month. You’d forget all about events that 1-2 months away and go on scavenger hunts to find that event from 3 months ago. On top of that, may of the calendar’s colour themes weren’t accessible.</p>
  {/* <Carousel
    slides={[
      {
        id: "1.01",
...
<Section id="2.00" title='Split view'>
  <p slot="context">We **broke the home page into two views: List & Calendar**. People liked seeing the events specially, but still needed a way to all events at a glance, organized by category (yours/others, past/upcoming, status). The calendar was redesigned to be denser, accessible and visually consistent.</p>
  <Carousel
    slides={[
      {
        id: "2.01",
