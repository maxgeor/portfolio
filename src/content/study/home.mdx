...
<Section id="2.00" title='Solution'>
  <p slot="context">We **split the home page into two views: List & Calendar**. People liked seeing events spacially, but needed a way to see everything at a glance. Two views gave people familiarity/utility of the original layout with the digestiblity of compact, organized lists. We also redesigned the calendar to be dense, accessible and visually consistent.</p>
  <Carousel
    slides={[
      {
        id: "2.01",
  ...
  >
    <Fragment slot="description">
      The List View organizes events into **Swimlanes & Timeline**. Swimlanes group events by category, like Your/Other's, Upcoming/Past, Invites/RSVPs. The Timeline shows everything from the calendar in chronological order. We made this the default view since most people come to the dashboard looking for a specific event ("I need to edit my event", "What do I need to bring for Cocktal Making?"), which was hard to do on the calendar.
    </Fragment>
  </Carousel>
  <Carousel
    slides={[
  ...
  >
    <Fragment slot="description">
      The Calendar View got **refreshed to maximize density**. Reducing text size, item padding and cell spacing let us fit double the calendar items. We also touched-up the themes to a [WACG-compliant](https://www.w3.org/mission/accessibility/) pastel pallate. It drove home Wavy's playful brand, and, you know, just looked better.
    </Fragment>
  </Carousel>
</Section>

<Section id="3.00" title="Differenciated Styles">
  <p slot="context"></p>
  <Image 
    id="3.01"
