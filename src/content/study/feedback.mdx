...
type: client
title: Wavy/Feedback
image: "/work/wavy/feedback/cover-lg.png"
roles: 
  - Product
teammates:
  [
...
<Section id="1.00" title='Problem' hasBorder={false}>
  <Fragment slot="context">
    After events, Wavy sent participants a feedback survey. It was an embedded [Typeform](https://www.typeform.com/) with 8 fixed questions the Wavy team picked over time. There were a few issues: 
    
    1/ Too many Qs, high dropoff rate. 2/ Organizers wanted to customize. 
    
    3/ The **platform never mentions surveys**. We only show survey data in the event's Insights tab after the event. 4/ Doesn't tell organizers it sends a survey, or what the questions will be. You only saw survey info in the insights tab, which summarized the event's participation and survey data. 5/ UI for event, was tightly coupled with fixed questions. To allow custom surveys, we'd need redesign insights tab to accomodate any kind of question.
  </Fragment>
</Section>
...
<Section id="3.00" title='Keeping old data'>
  <p slot="context">A big constraint on the project is we **didn't want to lose data from past surveys**. Some customers had been </p>
</Section>
