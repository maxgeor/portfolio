...
<Section id="4.00" title='Backwards compatability'>
...
<Section id="5.00" title='Written Feedback'>
  <p slot="context">We faced a challenge in showing averaged written feedback in the summary section. Quantitative data like ratings and multiple choice were easy to summarize, but written responses lacked a simple solution. We **used an LLM to summarize responses to long answer questions** whenever a new response was submitted. This allowed users to quickly understand how people felt without reading every response. If needed, the summarized section could be expanded to view individual feedback, making it easy to dive deeper when the summary wasn't enough.</p>
  <Image
    id="5.01"
