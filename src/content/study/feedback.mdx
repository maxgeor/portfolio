...
type: client
title: Wavy/Feedback
image: "/work/wavy/feedback/cover.png"
roles: 
  - Product
teammates:
  [
...
<Section id="2.00" title='Solution'>
  ...
  <Carousel
    ...
    isPadded={false}
  />
  <div class="hidden md:grid grid-cols-12 gap-x-[17px] col-span-full">
    <Image
      id="2.05"
      src="/work/formie/s4.png"
      alt="New form, find"
  ...
  <div class="hidden md:grid grid-cols-12 gap-[17px] col-span-full ">
    <Image
      id="2.08"
      src="/work/formie/s2.png"
      alt="Forms page"
