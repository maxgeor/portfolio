...
<h1 class="text-xl xs:!text-2xl sm:!text-3xl col-span-6 xl:col-start-2 bg-red/20 py-4 px-6 -mx-6 !-mb-6">What if we applied form builder patterns to smart contracts?</h1>
<OneTwoThree >
