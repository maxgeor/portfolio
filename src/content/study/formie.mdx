...
<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-x-4 mt-36">
  ...
  <span class="text-xl sm:text-2xl xl:text-3xl -mr-0.5 md:-mr-2 justify-self-end text-neutral-600 tracking-tight -mt-1 sm:-mt-2">02</span>
</div>
<h1 class="text-xl xs:!text-2xl sm:!text-3xl col-span-6 xl:col-start-2 bg-yellow/20 py-4 px-6 -mx-6 !-mb-6">What if we applied form builder patterns to smart contracts?</h1>
<OneTwoThree classes="xl:pb-12">
