...
<div class="col-span-full md:col-span-4 xl:col-span-2 xl:col-start-2  flex flex-col gap-y-4 !text-white">
...
<Heading title="So we looked for something better..." number="01">
  <img src="/path-l-to-r.svg" class="hidden xl:block max-h-[48px] h-full w-[50vw] absolute bottom-2 left-[46%] transform -translate-x-1/2 rotate-[2.5deg]" />
</Heading>

<div class="relative xl:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-full xl:col-span-2 ">
    <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 my-0 -mt-1 xl:max-w-[400px]">Most actions needed basic UIs</h2>
  ...
  <Image 
    ...
    classes="xl:order-first col-span-full xl:col-span-4 xl:col-start-2 !m-0"
  />
...
<div class="relative xl:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2 xl:pb-12">
    <h2 class="text-3xl md:text-4xl leading-8 md:leading-9 my-0 -mt-1 ">Projects used Etherscan for one-way actions</h2>
    <div class="flex flex-col gap-4">
...
<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 xl:pb-12">
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-full xl:col-span-2 ">
    <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 my-0 -mt-1 xl:max-w-[400px]">Projects sacrificed UX to save time</h2>
    <div class="flex flex-col gap-4">
  ...
  <Image 
    src="/work/formie/research/forms/etherscan-form-ui.png" 
    alt="Etherscan's UI for Uniswaps's Delegate method"
    classes="xl:order-first xl:order-auto col-span-full xl:col-span-4 xl:col-start-2 !m-0"
  />
...
<div class="-my-1.5 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-x-4 pt-36">
  ...
  <div class="col-span-1 -mr-2 justify-self-end text-[56px] leading-[48px] md:text-[80px] xl:text-[104px] md:leading-[68px] xl:leading-[92px]  text-neutral-700">02</div>
</div>

<h1 class="col-span-6 xl:col-start-2 bg-yellow/[15%] py-4 px-6 -mx-6 !-mb-6">What if we applied form builder patterns to smart contracts?</h1>

<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-y-4 gap-x-6 md:pb-12 tracking-tight">
...
> 
  ...
  <Heading title="So we got to work..." number="02" classes="!pt-0" />
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-full md:col-span-2 xl:col-start-2">
  <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 my-0 -mt-1 md:max-w-[400px]">Shooing scammers</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-full md:col-span-2">
  <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 my-0 -mt-1 md:max-w-[400px]">Keeping it flexible</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-full md:col-span-2">
  <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 my-0 -mt-1 md:max-w-[400px]">Communicating technical details</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <div class="flex justify-between gap-6">
      <h2 class="text-3xl md:text-4xl leading-8 md:leading-9 my-0">One page, one action</h2>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <div class="flex justify-between gap-6">
      <h2 class="text-3xl md:text-4xl leading-8 md:leading-9 my-0">Only supporting one-way actions</h2>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <div class="flex justify-between gap-6">
      <h2 class="text-3xl md:text-4xl leading-8 md:leading-9 my-0">Letting people write their own titles and descriptions</h2>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <div class="flex justify-between gap-6">
      <h2 class="text-3xl md:text-4xl leading-8 md:leading-9 my-0">Making people confirm trust</h2>
