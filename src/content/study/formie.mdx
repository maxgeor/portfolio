...
<div class="relative xl:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <Image 
    ...
    classes="lg:order-first col-span-full lg:col-span-4 xl:col-start-2 !m-0"
  />
...
<div class="relative xl:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 lg:pb-12">
  <div class="flex flex-col gap-4 col-span-full lg:col-span-2 xl:col-start-2 ">
    <h2 class="text-3xl md:text-4xl leading-8 md:leading-9 my-0 !-mt-1 md:max-w-[24ch]">Projects used Etherscan for one-way actions</h2>
    <div class="flex flex-col gap-4">
  ...
  <Carousel
    ...
    classes="col-span-full lg:col-span-4 !m-0"
  />
  <img 
    src="/path-l-to-r.svg" 
...
<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 lg:pb-12">
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-full lg:col-span-2 ">
    <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 !-mt-1 md:max-w-[24ch]">Projects sacrificed UX to save time</h2>
    <div class="flex flex-col gap-4">
...
<div class="-my-1.5 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-x-4 pt-36">
  <div class="xl:col-start-2 col-span-5 z-5 text-2xl md:text-3xl leading-7 md:leading-8 tracking-tight  text-neutral-500 max-w-md">Realizing smart contracts worked like mini forms made us wonder...</div>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-y-4 gap-x-6 xl:pb-12 tracking-tight">
  <div class="-my-1 col-span-full md:col-span-2 xl:col-start-2 text-xl md:text-2xl leading-6 md:leading-7 text-neutral-500 flex gap-4">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 justify-center py-6 md:py-12 xl:py-24 bg-white -mx-6">
  <Image
    src="/work/formie/first-idea-for-form-builder.png"
    alt="First sketch of form builder UI"
    classes="col-span-full xl:col-span-6 xl:col-start-2"
  />
</div>
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-full md:col-span-2 xl:col-start-2">
  <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 -mt-1 md:max-w-[400px]">Shooing scammers</h2>
  <div class="flex flex-col gap-4 ">
  ...
  <Image 
    ...
    classes="md:hidden col-span-full !m-0"
  />
</div>

<div class="flex flex-col gap-y-4 gap-x-6 col-span-full md:col-span-2">
  <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 -mt-1 md:max-w-[400px]">Keeping it flexible</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-full md:col-span-2">
  <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 -mt-1 md:max-w-[400px]">Communicating technical details</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="hidden md:grid col-span-full grid-cols-6 xl:grid-cols-8 -mx-6 py-24 bg-white mt-12">
  <Image 
    src="/work/formie/challenges/scam.png"
    alt="Thinking about how to handle bad guys"
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <div class="flex justify-between gap-6 -my-1">
      <h2 class="text-3xl md:text-4xl leading-8 md:leading-9">One page, one action</h2>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <div class="flex justify-between gap-6 -my-1">
      <h2 class="text-3xl md:text-4xl leading-8 md:leading-9">Only supporting one-way actions</h2>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <div class="flex justify-between gap-6 -my-1">
      <h2 class="text-3xl md:text-4xl leading-8 md:leading-9">Letting people write their own titles and descriptions</h2>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <div class="flex justify-between gap-6 -my-1">
      <h2 class="text-3xl md:text-4xl leading-8 md:leading-9">Making people confirm trust</h2>
