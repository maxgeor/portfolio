...
<div class="col-span-full grid grid-cols-8 gap-x-6 pt-36 -my-2 xl:-my-3">
  ...
  <div class="-my-1.5 col-span-1 col-start-8 xl:col-start-7 -mr-2 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">00</div>
</div>

<div class="pb-12 col-span-full grid grid-cols-8 gap-6 tracking-[-0.04em]">
  <div class="text-2xl leading-7   col-span-2 text-neutral-400 col-start-2 flex gap-6 max-w-[17ch]">
    <span class="w-3.5 ">1.</span>
    <span class="my-0 ">The UI is a list of <span>technically-named</span> forms.</span>
  </div>
  <div class="text-2xl leading-7   col-span-2 text-neutral-400 flex gap-6 max-w-[17ch]">
...
<div class="relative col-span-full grid grid-cols-8 gap-x-4 my-24 mb-12">
  <h1 class="col-span-5 col-start-2 z-5 max-w-[13ch] !mt-0 !mb-0">So we looked for something better...</h1>
  <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">01</div>
  <img src="/path-l-to-r.svg" class="max-h-[48px] h-full w-[50vw] absolute -bottom-[80px] left-[46%] transform -translate-x-1/2 rotate-[2.5deg]" />
</div>
...
<div class="relative pb-12 col-span-full grid grid-cols-8 gap-6">
  ...
  <img src="/path-r-to-l.svg" class="max-h-[60px] h-full w-[50vw] absolute -bottom-8 left-[46%] transform -translate-x-1/2 -rotate-[2.5deg]" />
</div>
...
<div class="relative pb-12 col-span-full grid grid-cols-8 gap-6 ">
  ...
  <Carousel
    ...
    classes="col-span-4 "
  />
  <img src="/path-l-to-r.svg" class="max-h-[50px] h-full w-[50vw] absolute -bottom-0 left-[46%] transform -translate-x-1/2 rotate-[2.5deg]" />
</div>
...
<div class="-my-1.5 col-span-full grid grid-cols-8 gap-x-4 pt-36 pb-12">
  <div class="col-start-2 col-span-3 z-5 text-3xl tracking-tight    text-neutral-400">Realizing smart contracts worked like mini forms made us wonder...</div>
  <div class="-my-1.5 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">02</div>
</div>
...
<div class="col-span-full grid grid-cols-8 gap-x-4 pb-12">
  <div class="-my-1 col-start-2 text-2xl leading-7   col-span-2 text-neutral-400 flex gap-6 max-w-[15ch]">
    <span class="my-0">Give every action a [dedicated page](#one-page-one-action).</span>
  </div>
  <div class="-my-1  text-2xl leading-7   col-span-2 text-neutral-400 flex gap-6 max-w-[15ch]">
...
>
  ...
  <div class="relative col-span-full grid grid-cols-8 gap-x-4 -my-1.5">
    ...
    <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">03</div>
  </div>
...
<div class="col-span-full grid grid-cols-8 gap-x-4 mb-12">
  ...
  <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">04</div>
</div>
...
<div class="col-span-full grid grid-cols-8 gap-x-4 mt-36 mb-12">
  <h1 class="col-span-5 col-start-2 z-5  max-w-[10ch]">So we made a few decisions...</h1>
  <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">05</div>
</div>

<div class="col-span-full grid grid-cols-8 gap-6">
  <span class="text-neutral-700  text-7xl leading-[40px] justify-self-end mr-4">1</span>
...
<div class="col-span-full grid grid-cols-8 gap-6">
  <span class="text-neutral-700  text-7xl leading-[40px] justify-self-end mr-4">2</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
...
<div class="col-span-full grid grid-cols-8 gap-6">
  <span class="text-neutral-700  text-7xl leading-[40px] justify-self-end mr-5 ">3</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
...
<div class="col-span-full grid grid-cols-8 gap-6">
  <span class="text-neutral-700  text-7xl leading-[40px] justify-self-end mr-4">4</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
