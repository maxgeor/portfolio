...
<div class="relative md:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <Image 
    ...
    classes="md:order-first col-span-full md:col-span-4 xl:col-start-2"
  />
...
<div class="relative xl:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 md:pb-12">
  ...
  <Carousel
    ...
    classes="col-span-full md:col-span-4 !-mx-0"
  />
  <img 
    src="/path-l-to-r.svg" 
...
<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 md:pb-12">
  ...
  <Video 
    ...
    alt="Etherscan's UI for Uniswaps's Delegate method"
    gridClasses="md:order-first col-span-full md:col-span-4 xl:col-start-2"
  />
...
<div class="relative col-span-full xl:col-span-6 xl:col-start-2 grid grid-cols-6 gap-x-4 border-t-[0.5px] border-white md:border-none pt-4 md:pt-0 mt-12 md:mt-36">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-full md:col-span-2 xl:col-start-2">
  ...
  <div class="mt-1 md:mt-auto px-4 py-3 rounded bg-neutral-800 ">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-full md:col-span-2">
  ...
  <div class="mt-1 md:mt-auto px-4 py-3 bg-neutral-800 rounded">
