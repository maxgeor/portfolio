...
<div class="col-span-full grid grid-cols-8 -mx-6 py-12 bg-white">
  <Image 
...
<div class="col-span-full grid grid-cols-8 gap-x-4 mt-36 mb-12">
  ...
  <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-mono text-neutral-700">05</div>
</div>

<div class="col-span-full grid grid-cols-8 gap-6 ">
  <span class="text-neutral-700 font-medium text-7xl leading-[48px] justify-self-end mr-6">1</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
...
<div class="col-span-full grid grid-cols-8 gap-6 ">
  <span class="text-neutral-700 font-medium text-7xl leading-[48px] justify-self-end mr-6">2</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
...
<div class="col-span-full grid grid-cols-8 gap-6 ">
  <span class="text-neutral-700 font-medium text-7xl leading-[48px] justify-self-end mr-6">3</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
...
<div class="col-span-full grid grid-cols-8 gap-6 ">
  <span class="text-neutral-700 font-medium text-7xl leading-[48px] justify-self-end mr-6">4</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
