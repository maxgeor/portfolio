...
<div class="col-span-full grid grid-cols-8 gap-x-6 pt-36 -my-2 xl:-my-3">
  ...
  <div class="-my-1.5 col-span-1 col-start-8 xl:col-start-7 -mr-2 justify-self-end !text-[104px] !leading-[96px] font-mono text-neutral-800">00</div>
</div>
...
<div class="relative col-span-full grid grid-cols-8 gap-x-4 mt-36 mb-24">
  ...
  <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-mono text-neutral-800">01</div>
...
<div class="-my-1.5 col-span-full grid grid-cols-8 gap-x-4 pt-36 pb-12">
  ...
  <div class="-my-1.5 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-mono text-neutral-800">02</div>
</div>
...
<div 
  class="relative col-span-full grid grid-cols-8 gap-6 gap-y-12 px-6 -mx-6 py-36"
  style={`  
...
>
  ...
  <div class="absolute top-0 left-0 h-32 w-full bg-gradient-to-b from-black/[40%] via-black/[30%]"></div>
  <div class="absolute bottom-0 left-0 h-32 w-full bg-gradient-to-t from-black/[40%] via-black/[30%]"></div>
  <div class="relative col-span-full grid grid-cols-8 gap-x-4 -my-1.5">
    ...
    <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-mono text-neutral-800">03</div>
  </div>
