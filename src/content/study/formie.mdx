...
<div class="relative md:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  ...
  <Image 
    ...
    classes="md:order-first col-span-full md:col-span-4 xl:col-start-2 -mx-6 md:!m-0"
  />
...
<div class="relative xl:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 md:pb-12">
  ...
  <Carousel
    ...
    classes="col-span-full md:col-span-4 -mx-6 md:!m-0"
  />
  <img 
    src="/path-l-to-r.svg" 
...
<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 md:pb-12">
  ...
  <Video 
    ...
    alt="Etherscan's UI for Uniswaps's Delegate method"
    gridClasses="md:order-first col-span-full md:col-span-4 xl:col-start-2 !-mx-6 md:!m-0"
  />
...
<div class="relative col-span-full xl:col-span-6 xl:col-start-2 grid grid-cols-6 gap-x-4 border-t-[0.5px] border-white md:border-none pt-4 md:pt-0 mt-12 md:mt-36">
  <span class="self-start -my-1 col-span-4 lg:col-span-2 z-5 text-md tracking-tight !text-neutral-500 max-w-xs md:max-w-md">Realizing smart contracts worked like mini forms made us wonder...</span>
...
<h1 class="col-span-6 xl:col-start-2 -my-1 sm:-my-2 xl:-my-3">What if we applied form builder patterns to smart contracts?</h1>
<OneTwoThree >
