...
<div class="relative xl:pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-full xl:col-span-2 ">
    <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 !-mt-1 xl:max-w-[400px]">Most actions needed basic UIs</h2>
...
<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 xl:pb-12">
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-full xl:col-span-2 ">
    <h2 class="col-span-full text-3xl md:text-4xl leading-8 md:leading-9 !-mt-1 xl:max-w-[400px]">Projects sacrificed UX to save time</h2>
    <div class="flex flex-col gap-4">
