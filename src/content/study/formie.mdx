...
<div class="flex flex-col gap-y-4 col-span-full md:col-span-2 xl:col-start-2">
...
<Image
  ...
  classes="col-span-full md:col-span-4 md:!mx-0"
/>
...
<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-x-4 mt-36">
  ...
  <span 
    class="absolute md:static -mr-2 right-0 top-0 z-0 justify-self-end text-2xl leading-[48px] sm:text-3xl sm:leading-[60px] xl:text-4xl xl:leading-[88px] text-[#1e1e1e] tracking-tight"
  >02</span>
</div>
