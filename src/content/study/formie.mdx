...
tldr: 
  ...
  decisions:
    - One page, one action
    - Force people to confirm trust
    - Only support one-way actions
    - Write your own titles & descriptions
  tradeoffs:
    - No editing
...
<Context title='Problem'>
  <p>Lots of smart contract developers hate building frontends. Instead, many use "frontend generators" to get a free, working UI in minutes. <a href="https://etherscan.io/" target="_blank">Etherscan</a> is the most popular one, powering tons of Ethereum projects.</p>
