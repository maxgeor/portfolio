...
<Heading title="Etherscan's UI kinda sucked..." number="00" />
<div class="pb-0 col-span-full grid grid-cols-1 sm:grid-cols-6 xl:grid-cols-8 gap-y-4 gap-x-6 tracking-tight">
  <div class="text-2xl  xl:col-start-2 col-span-full md:col-span-2 text-neutral-500 flex gap-4 leading-7 ">
    <span class="w-3.5">1.</span>
    <span class="my-0 ">The UI is a list of <span>technically-named</span> forms.</span>
  </div>
  <div class="text-2xl col-span-full md:col-span-2 text-neutral-500 flex gap-4 leading-7 ">
...
<Heading title="So we looked for something better..." number="01" classes="pb-24">
  <img src="/path-l-to-r.svg" class="max-h-[48px] h-full w-[75vw]xl:w-[50vw] absolute bottom-2 left-[46%] transform -translate-x-1/2 rotate-[2.5deg]" />
</Heading>

<div class="relative pb-24 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-full xl:col-span-2 ">
    <h2 class="col-span-full text-4xl leading-9 my-0 -mt-1 xl:max-w-[400px]">Most actions needed basic UIs</h2>
  ...
  />
  <img src="/path-r-to-l.svg" class="max-h-[60px] h-full xl:w-[50vw] absolute -bottom-2 left-1/2 transform -translate-x-1/2 -rotate-[2.5deg]" />
</div>

<div class="relative pb-12 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2 pb-12">
    <h2 class="text-4xl leading-9 my-0 -mt-1 ">Projects used Etherscan for one-way actions</h2>
    <div class="flex flex-col gap-4">
  ...
  <img 
    src="/path-l-to-r.svg" 
    class="max-h-[50px] h-full w-[50vw] absolute bottom-0 left-[46%] transform -translate-x-1/2 rotate-[2.5deg]" 
  />
</div>

<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 pb-12 ">
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-full xl:col-span-2 ">
    <h2 class="col-span-full text-4xl leading-9 my-0 -mt-1 max-w-[400px]">Projects sacrificed UX to save time</h2>
    <div class="flex flex-col gap-4">
...
<div class="-my-1.5 col-span-full grid grid-cols-6 xl:grid-cols-8 gap-x-4 pt-36 ">
  <div class="xl:col-start-2 col-span-5 z-5 text-3xl tracking-tight  text-neutral-500 max-w-md">Realizing smart contracts worked like mini forms made us wonder...</div>
  <div class="-my-1.5 col-span-1 -mr-3 justify-self-end text-[80px] xl:text-[104px] leading-[68px] xl:leading-[96px]  text-neutral-700">02</div>
</div>

<h1 class="col-span-6 xl:col-start-2 bg-yellow/[15%] py-4 px-6 -mx-6">What if we applied form builder patterns to smart contracts?</h1>

<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-y-4 gap-x-6 pb-12 tracking-tight">
  <div class="-my-1 col-span-full md:col-span-2 xl:col-start-2 text-2xl leading-7 text-neutral-500 flex gap-4">
    <div class="w-3.5">1.</div>
    <span class="my-0 md:max-w-[15ch]">Give every action a [dedicated page](#one-page-one-action).</span>
  </div>
  <div class="-my-1 text-2xl leading-7 col-span-full md:col-span-2 text-neutral-500 flex gap-4">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-x-6 gap-y-4">
  <div class="col-span-full md:col-span-2 xl:col-start-2 flex flex-col gap-4 text-neutral-200 max-w-[200px] ">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 justify-center py-24 bg-white -mx-6">
  <Image
...
<div 
  class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 gap-y-12 px-6 -mx-6 py-56 -my-12"
  style={`  
...
<Heading title="But we had some issues..." number="04" classes="!pt-0 pb-12" />
<div class="flex flex-col gap-y-4 gap-x-6 col-span-2 col-start-2">
  <h2 class="col-span-full text-4xl leading-9 my-0 -mt-1 max-w-[400px]">Shooing scammers</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-2">
  <h2 class="col-span-full text-4xl leading-9 my-0 -mt-1 max-w-[400px]">Keeping it flexible</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-2">
  <h2 class="col-span-full text-4xl leading-9 my-0 -mt-1 max-w-[400px]">Communicating technical details</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 -mx-6 py-24 bg-white mt-12">
  <Image 
...
<Heading title="So we made a few decisions..." number="05" classes="pb-12" />
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <span class="text-neutral-700  text-6xl justify-self-end mr-4">1</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
    <h2 class="text-4xl leading-9 my-0">One page, one action</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <span class="text-neutral-700 text-6xl justify-self-end mr-4">2</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
    <h2 class="text-4xl leading-9 my-0">Only supporting one-way actions</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <span class="text-neutral-700 text-6xl justify-self-end mr-5 ">3</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
    <h2 class="text-4xl leading-9 my-0">Letting people write their own titles and descriptions</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <span class="text-neutral-700 text-6xl justify-self-end mr-4">4</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
    <h2 class="text-4xl leading-9 my-0">Making people confirm trust</h2>
    <div class="flex flex-col gap-4">
