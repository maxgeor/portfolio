...
<div class="col-span-full grid grid-cols-12 gap-x-6 pt-36 -my-2 xl:-my-3">
  <h1 class="col-span-9 col-start-2   z-5  max-w-[12ch] !-ml-1.5">Etherscan's UI kinda sucked...</h1>
  <div class="-my-1.5 col-span-1 -mr-2 justify-self-end !text-[96px] !leading-[96px]  text-neutral-700">00</div>
</div>
<div class="pb-12 col-span-full grid grid-cols-12 gap-6 tracking-[-0.04em]">
  <div class="text-3xl  col-start-2 col-span-3 text-neutral-500 flex gap-6 ">
    <span class="w-3.5 ">1.</span>
    <span class="my-0 ">The UI is a list of <span>technically-named</span> forms.</span>
  </div>
  <div class="text-3xl  col-span-3 text-neutral-500 flex gap-6 ">
...
<div class=" col-span-3 col-start-2  flex flex-col gap-y-4 !text-white">
...
{/* <div class="pb-12 col-span-full grid grid-cols-12 gap-6 ">
  <div class=" col-span-4 xl:col-span-3 xl:col-start-3 flex flex-col gap-y-4 text-neutral-200">
    Developers make blockchain apps by
...
<div class="relative col-span-full grid grid-cols-12 gap-x-4 my-24 mb-12">
  <h1 class="col-span-9 col-start-2 z-5 max-w-[13ch] !mt-0 !mb-0">So we looked for something better...</h1>
  <div class="-my-1 col-span-1  -mr-3 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">01</div>
...
<div class="relative pb-12 col-span-full grid grid-cols-12 gap-6">
  <Image 
    src="/work/formie/research/forms/etherscan-form-ui.png" 
    alt="Etherscan's UI for Uniswaps's Delegate method"
    classes="col-span-5 xl:col-span-6 xl:col-start-2 "
  />
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-3">
...
<div class="relative pb-12 col-span-full grid grid-cols-12 gap-6 ">
  <div class="flex flex-col gap-4 col-span-3  col-start-2 pb-12">
...
<div class="relative pb-12 col-span-full grid grid-cols-12 gap-6 ">
  <Image 
    src="/work/formie/research/forms/etherscan-form-ui.png" 
    alt="Etherscan's UI for Uniswaps's Delegate method"
    classes="col-span-6 xl:col-start-2 "
  />
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-3 ">
...
<div class="-my-1.5 col-span-full grid grid-cols-12 gap-x-4 pt-36 ">
  <div class="col-start-2 col-span-4 z-5 text-3xl tracking-tight    text-neutral-400">Realizing smart contracts worked like mini forms made us wonder...</div>
  <div class="-my-1.5 col-span-1 col-start-11 -mr-3 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">02</div>
</div>

<h1 class="col-span-9 col-start-2 bg-white/[15%]  py-4 px-6 -mx-6 -my-[24px]">What if we applied form builder patterns to smart contracts?</h1>

<div class="col-span-full grid grid-cols-12 gap-x-4 pb-12">
  <div class="-my-1 col-start-2 text-2xl leading-7   col-span-3 text-neutral-400 flex gap-6 max-w-[15ch]">
    <span class="my-0">Give every action a [dedicated page](#one-page-one-action).</span>
  </div>
  <div class="-my-1  text-2xl leading-7   col-span-3 text-neutral-400 flex gap-6 max-w-[15ch]">
...
<div class="col-span-full grid grid-cols-12 gap-x-6 gap-y-4">
  ...
  <div class=" col-span-3 col-start-5 flex flex-col gap-4 text-neutral-200 ">
...
<div class="col-span-full grid grid-cols-12 justify-center py-12 bg-white -mx-6">
  <Image
    src="/work/formie/first-idea-for-form-builder.png"
    alt="First sketch of form builder UI"
    classes="col-span-full lg:col-span-8 lg:col-start-3"
    
  />
</div>

<div 
  class="relative col-span-full grid grid-cols-12 gap-6 gap-y-12 px-6 -mx-6 py-48 -my-12"
  style={`  
...
>
  ...
  <div class="relative col-span-full grid grid-cols-12 gap-x-4 -my-1.5">
    <h1 class="col-span-9 col-start-2 z-5 max-w-[10ch] !mt-0 !mb-0">So we got to work...</h1>
    <div class="-my-1 col-span-1 -mr-3 justify-self-end !text-[104px] !leading-[96px]  text-neutral-700">03</div>
  </div>
...
<div class="col-span-full grid grid-cols-12 gap-x-4 mb-12">
...
<div class="col-span-full grid grid-cols-12 -mx-6 py-12 bg-white mt-12">
  <Image 
...
<div class="col-span-full grid grid-cols-12 gap-x-4 mt-36 mb-12">
