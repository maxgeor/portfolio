...
<div class="relative col-span-full grid grid-cols-8 gap-x-4 mt-36 mb-24">
...
<div class="-my-1.5 col-span-full grid grid-cols-8 gap-x-4 pt-36 pb-12">
  <div class="col-start-2 col-span-3 z-5 text-3xl  font-medium text-neutral-500">Realizing smart contracts worked like mini forms made us wonder...</div>
...
<div class="col-span-full flex items-center justify-center py-12 bg-white -mx-6 px-6">
  <Image
    src="/work/formie/first-idea-for-form-builder.png"
    alt="First sketch of form builder UI"
    classes="col-span-full lg:col-span-6 col-start-2 "
...
<div 
  ...
  `}
>
  <div class="absolute top-0 left-0 h-48 w-full bg-gradient-to-b from-black/[40%] via-black/[35%]"></div>
  <div class="absolute bottom-0 left-0 h-48 w-full bg-gradient-to-t from-black/[50%] via-black/[35%]"></div>
