...
<div class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-x-4 mt-12 md:mt-36">
  ...
  <span class="text-xl sm:text-2xl xl:text-3xl -mr-0.5 md:-mr-2 justify-self-end text-neutral-600 tracking-tight -my-1 sm:-my-2">02</span>
</div>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 md:py-12 bg-white -mx-6">
  <Image
    src="/work/formie/first-idea-for-form-builder.png"
    alt="First sketch of form builder UI"
    classes="col-span-6 md:col-span-4 xl:col-span-6 md:col-start-2 xl:col-start-2 "
  />
</div>
