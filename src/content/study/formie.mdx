...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 justify-center py-2 md:py-12 xl:py-24 bg-white -mx-6">
  <Image
    src="/work/formie/first-idea-for-form-builder.png"
    alt="First sketch of form builder UI"
    classes="col-span-full xl:col-span-4 xl:col-start-2"
  />
</div>
