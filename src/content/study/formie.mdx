...
<div class="col-span-full grid grid-cols-8 gap-x-6 pt-36 -my-2 xl:-my-3">
  <h1 class="col-span-5 xl:col-start-2 z-5  max-w-[12ch] !mt-0 !mb-0 !-ml-1.5">Etherscan's UI kinda sucked...</h1>
...
<div class="pb-12 col-span-full grid grid-cols-8 gap-6 ">
  <div class="text-2xl leading-7 font-serif italic col-span-2 text-neutral-500 col-start-2 flex gap-6 max-w-[17ch]">
    <span class="w-3.5 ">1.</span>
    <span class="my-0 ">The UI is a list of <span>technically-named</span> forms.</span>
  </div>
  <div class="text-2xl leading-7 font-serif italic col-span-2 text-neutral-500 flex gap-6 max-w-[17ch]">
...
<div class="relative col-span-full grid grid-cols-8 gap-x-4 my-24">
  <h1 class="col-span-5 col-start-2 z-5 max-w-[13ch] !mt-0 !mb-0">So we looked for something better...</h1>
...
<div class="relative pb-24 col-span-full grid grid-cols-8 gap-6">
  ...
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-3 xl:col-span-2">
    <h2 class="col-span-full text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1 max-w-[400px]">Most actions needed basic UIs</h2>
...
<div class="relative pb-24 col-span-full grid grid-cols-8 gap-6 ">
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1 ">Projects used Etherscan for one-way actions</h2>
    <div class="flex flex-col gap-4">
...
<div class="relative pb-12 col-span-full grid grid-cols-8 gap-6 ">
  ...
  />
  <div class="flex flex-col gap-y-4 gap-x-6 col-span-3 xl:col-span-2">
    <h2 class="col-span-full text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1 max-w-[400px]">Projects sacrificed UX to save time</h2>
    <div class="flex flex-col gap-4">
  ...
  <img src="/path-r-to-c.svg" class="max-h-[170px] h-full absolute -bottom-[9.75rem] left-1/2 transform -translate-x-1/2" />
</div>

<div class="-my-1.5 col-span-full grid grid-cols-8 gap-x-4 pt-36 pb-12">
  <div class="col-start-2 col-span-3 z-5 text-3xl tracking-tight font-serif italic  text-neutral-500">Realizing smart contracts worked like mini forms made us wonder...</div>
  <div class="-my-1.5 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-serif text-neutral-700">02</div>
</div>

<h1 class="col-span-6 col-start-2 bg-yellow/20  py-4 px-6 -mx-6 -my-[24px]">What if we applied form builder patterns to smart contracts?</h1>

<div class="col-span-full grid grid-cols-8 gap-x-4 pb-12">
  <div class="-my-1 col-start-2 text-2xl leading-7 font-serif italic col-span-2 text-neutral-500 flex gap-6 max-w-[15ch]">
    <span class="my-0">Give every action a [dedicated page](#one-page-one-action).</span>
  </div>
  <div class="-my-1  text-2xl leading-7 font-serif italic col-span-2 text-neutral-500 flex gap-6 max-w-[15ch]">
...
<div class="col-span-full grid grid-cols-8 justify-center py-12 bg-white -mx-6">
  <Image
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-2 xl:col-start-2 ">
  <h2 class="col-span-full text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1 max-w-[400px]">Shooing scammers</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-2">
  <h2 class="col-span-full text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1 max-w-[400px]">Keeping it flexible</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="flex flex-col gap-y-4 gap-x-6 col-span-2">
  <h2 class="col-span-full text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1 max-w-[400px]">Communicating technical details</h2>
  <div class="flex flex-col gap-4 ">
...
<div class="col-span-full grid grid-cols-8 gap-x-4 mt-36 mb-12">
  <h1 class="col-span-5 col-start-2 z-5  !mt-0 !mb-0 max-w-[12ch]">So we made a few decisions...</h1>
...
<div class="col-span-full grid grid-cols-8 gap-6">
  <span class="text-neutral-700 font-serif text-7xl leading-[40px] justify-self-end mr-4">1</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0">One page, one action</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-8 gap-6">
  <span class="text-neutral-700 font-serif text-7xl leading-[40px] justify-self-end mr-4">2</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0">Only supporting one-way actions</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-8 gap-6">
  <span class="text-neutral-700 font-serif text-7xl leading-[40px] justify-self-end mr-5 ">3</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0">Letting people write their own titles and descriptions</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-8 gap-6">
  <span class="text-neutral-700 font-serif text-7xl leading-[40px] justify-self-end mr-4">4</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0  ">Making people confirm trust</h2>
    <div class="flex flex-col gap-4">
