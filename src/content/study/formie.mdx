...
<div class="col-span-full grid grid-cols-8 gap-x-6 gap-y-4">
  {/* <hr class="border-t border-[#393939] col-span-6 col-start-2" /> */}
...
<div class="col-span-full grid grid-cols-8 gap-x-6 gap-y-4 py-12 bg-white">
  <Image
    src="/work/formie/first-idea-for-form-builder.png"
    alt="First sketch of form builder UI"
    classes="col-span-6 col-start-2 "
  />
</div>
...
>
  ...
  <div class="absolute top-0 left-0 h-48 w-full bg-gradient-to-b from-black/[50%] via-black/[40%]"></div>
  <div class="absolute bottom-0 left-0 h-48 w-full bg-gradient-to-t from-black/[50%] via-black/[40%]"></div>
  ...
  <img
    ...
    class="col-span-full -mt-6 transform "
  />
</div>
