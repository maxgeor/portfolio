...
{/* <div 
  class="relative col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6 gap-y-12 px-6 -mx-6 py-24 md:py-48 -my-12"
> 
  <div class="absolute top-0 left-0 h-48 w-full bg-gradient-to-b from-black via-black/[50%]"></div>
  <Heading title="So we got to work..." number="03" classes="!pb-0 xl:pb-12 !pt-0" />
  <div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-y-4 gap-x-6">
    <div class="col-span-full md:col-span-2 xl:col-start-2">
      We worked by doing design and development at the same time.
    </div>
...
<img 
  ...
  class="hidden md:block col-span-full !mt-12 "
/>
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <span class="hidden xl:block text-neutral-700 text-2xl -my-1.5 justify-self-end mr-4">1</span>
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2">
    <h2 class="-my-1">One page, one action</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <span class="hidden xl:block text-neutral-700 text-2xl -my-1.5 justify-self-end mr-4">2</span>
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <h2 class="-my-1">Only supporting one-way actions</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <span class="hidden xl:block text-neutral-700 text-2xl -my-1.5 justify-self-end mr-5">3</span>
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
    <h2 class="-my-1">Letting people write their own titles and descriptions</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-6 xl:grid-cols-8 gap-6">
  <span class="hidden xl:block text-neutral-700 text-2xl -my-1.5 justify-self-end mr-4">4</span>
  <div class="flex flex-col gap-4 col-span-full xl:col-span-2 xl:col-start-2">
