...
<div class="col-span-full grid grid-cols-8 gap-x-6 pt-36 -my-2 xl:-my-3">
  ...
  <div class="-my-1.5 col-span-1 col-start-8 xl:col-start-7 -mr-2 justify-self-end !text-[104px] !leading-[96px] font-serif text-neutral-700">00</div>
</div>

<div class="pb-12 col-span-full grid grid-cols-8 gap-6 ">
  <div class="text-2xl leading-7 font-serif italic tracking-tight col-span-2 text-neutral-500 col-start-2 flex gap-6 max-w-[15ch]">
    <span class="w-3.5 ">1.</span>
    <span class="my-0 ">The UI is a list of <span>technically-named</span> forms.</span>
  </div>
  <div class="text-2xl leading-7 font-serif italic tracking-tight  col-span-2 text-neutral-500 flex gap-6 max-w-[15ch]">
...
<div class="relative col-span-full grid grid-cols-8 gap-x-4 my-24">
  ...
  <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-serif text-neutral-700">01</div>
...
<div class="-my-1.5 col-span-full grid grid-cols-8 gap-x-4 pt-36 pb-12">
  <div class="col-start-2 col-span-3 z-5 text-3xl  font-serif italic tracking-tight text-neutral-500">Realizing smart contracts worked like mini forms made us wonder...</div>
  <div class="-my-1.5 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-serif text-neutral-700">02</div>
</div>
...
<div class="col-span-full grid grid-cols-8 gap-x-4 pb-12">
  <div class="-my-1 col-start-2 text-2xl leading-7 font-serif italic tracking-tight col-span-2 text-neutral-500 flex gap-6 max-w-[15ch]">
    <span class="my-0">Give every action a [dedicated page](#one-page-one-action).</span>
  </div>
  <div class="-my-1  text-2xl leading-7 font-serif italic tracking-tight  col-span-2 text-neutral-500 flex gap-6 max-w-[15ch]">
...
<div class="col-span-full grid grid-cols-8 gap-x-6 gap-y-4">
  ...
  <div class=" col-span-2 col-start-4 flex flex-col gap-4 text-neutral-200 ">
...
>
  ...
  <div class="relative col-span-full grid grid-cols-8 gap-x-4 -my-1.5">
    ...
    <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-serif text-neutral-700">03</div>
  </div>
...
<div class="col-span-full grid grid-cols-8 gap-x-4 mb-12">
  ...
  <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-serif text-neutral-700">04</div>
</div>
...
<div class="col-span-full grid grid-cols-8 -mx-6 py-12 bg-white mt-12">
  <Image 
...
<div class="col-span-full grid grid-cols-8 gap-x-4 mt-36 mb-12">
  <h1 class="col-span-5 col-start-2 z-5  !mt-0 !mb-0 max-w-[10ch]">So we made a few decisions...</h1>
  <div class="-my-1 col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-serif text-neutral-700">05</div>
</div>

<div class="col-span-full grid grid-cols-8 gap-6 ">
  <span class="text-neutral-700 font-serif italic text-7xl leading-[48px] justify-self-end mr-6">1</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1.5 ">One page, one action</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-8 gap-6 ">
  <span class="text-neutral-700 font-serif italic text-7xl leading-[48px] justify-self-end mr-6">2</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1.5 ">Only supporting one-way actions</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-8 gap-6 ">
  <span class="text-neutral-700 font-serif italic text-7xl leading-[48px] justify-self-end mr-6">3</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1.5 ">Letting people write their own titles and descriptions</h2>
    <div class="flex flex-col gap-4">
...
<div class="col-span-full grid grid-cols-8 gap-6 ">
  <span class="text-neutral-700 font-serif italic text-7xl leading-[48px] justify-self-end mr-6">4</span>
  <div class="flex flex-col gap-4 col-span-3 xl:col-span-2 xl:col-start-2 pb-12">
    <h2 class="text-3xl xl:text-4xl leading-8 xl:leading-9 my-0 -mt-1.5 ">Making people confirm trust</h2>
    <div class="flex flex-col gap-4">
