...
<Section id="2.00" title='Form UI'>
  <p slot="context">Realizing smart contracts worked like mini forms made us wonder: What if we <mark class="solution">applied form builder patterns to smart contracts</mark>? You could solve most of the UX issues by [1] giving every action a [dedicated page](#one-page-one-action), [2] letting people [write their own copy](#letting-people-write-their-own-titles-and-descriptions) [3] sharing clear, thoughtful feedback about transactions.</p>
  <Carousel
    slides={[
      {
        id: "2.01",
