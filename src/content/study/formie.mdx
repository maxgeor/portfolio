...
<div class="col-span-full grid grid-cols-8 gap-x-6 pt-36 -my-2 xl:-my-3">
  <h1 class="col-span-5 col-start-2 z-5 !text-7xl xl:!text-8xl max-w-[10ch] !mt-0 !mb-0 !-ml-1.5">Etherscan's UI kinda sucked...</h1>
  <div class="col-span-1 col-start-7 -mr-2 justify-self-end !text-[104px] !leading-[96px] font-mono text-[#262626]">00</div>
</div>
...
<div class="pb-12 col-span-full grid grid-cols-8 gap-6 ">
  <div class="text-2xl leading-7 font-medium tracking-tight col-span-2 text-neutral-500 col-start-2 flex gap-6 max-w-[15ch]">
    ...
    <span class="my-0 ">The UI is a list of <span class="text-white">technically-named</span> forms.</span>
  </div>
  <div class="text-2xl leading-7 font-medium tracking-tight  col-span-2 text-neutral-500 flex gap-6 max-w-[15ch]">
    ...
    <span class=" my-0  col-start-6 ">It’s at the <span class="text-white">bottom of the page</span>, behind two drawers.</span>
  </div>
  <div class="text-2xl leading-7 font-medium tracking-tight col-span-2 text-neutral-500 flex gap-6 max-w-[15ch]">
    <div class="w-3.5 ">3.</div>
    <span class="my-0 ">They share <span class="text-white">limited feedback</span> for transactions.</span>
  </div>
</div>
...
<div class="col-span-full grid grid-cols-8 gap-x-4 mt-36 mb-12">
  <h1 class="col-span-5 col-start-2 z-5 !text-8xl max-w-[12ch] !mt-0 !mb-0">So we sought <br/> another path...</h1>
  <div class="col-span-1 col-start-7 -mr-3 justify-self-end !text-[104px] !leading-[96px] font-mono text-neutral-800">01</div>
</div>
