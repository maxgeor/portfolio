...
<div class="mt-16 grid grid-cols-1 md:grid-cols-6 gap-4 col-span-full col-start-2 col-end-8">
  <h1 class="!text-7xl col-span-3 !mt-0">Etherscan's UI kinda sucked...</h1>
