  ...
  [
    {
      name: Dan Stein,
      role: Design,
      link: https://www.linkedin.com/in/dansteinart/,
    },
  ]
roles: [UX & UI Design, Fullstack Development]
tools: [Ruby on Rails, Hotwire, TailwindCSS]
tldr: Feature I built and co-designed for Wavy that lets teams vote for their next team event.
---
