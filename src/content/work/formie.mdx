...
<Section title="Only supporting one-way actions">
  ...
  >
    ...
    One-way actions are simple — they need some fields, a button, and a straightforward layout. Our research also <a class="anchor" href="#research">found that they're underserved</a> compared to two-way actions.
