...
<Section title="Idea">
  ...
  > 
    We cracked the nut by framing smart contract actions as mini forms.
    ...
    - Layers of irrelevant stuff hide the only UI that matters
    - Users have to decipher every action name to find the right one

    With this, we got our high-level solution: **A tool, like Google Forms, that creates landing pages for smart contract actions**.
...
<Section title="Research">
  <SubSection>
    ...
    - **Everyone knew Etherscan sucked** (visually & functionally) but weren't willing to build something themselves.
