...
<Section title="Problem">
  ...
  >
    ...
    <hr class="h-px border-t border-[#d3d7dc] border-dashed my-0"></hr>
...
<Section title="Process">
  <SubSection hasDoubleMargin={true}>
    ## Research
    ...
    3. _Etherscan was mostly used for <a class="anchor" href="#only-supporting-one-way-actions">one-way actions</a>_ (two-way actions tended to have custom frontends).
  ...
  <SubSection
    images={[
      { 
        ...
        alt: "Me musing on how to handle bad guys",
      },
      { 
        src: "/work/formie/challenges/explain.png", 
        alt: "Me figuring out how to explain stuff",
      },
    ]} 
    isUsingCarouselle={true}
  >
    {/* ## Shooing scammers */}
    <h2 id="shooing-scammers">
      Shooing scammers
    </h2>
    ...
    <h2 id="filtering--framing-technical-details" class="lg:mt-6">
      Filtering & framing technical details
    </h2>
    ...
    <a class="anchor" href="#using-human-words">How do we explain difficult ideas</a> without overwhelming people? Which ideas are essential?

    {/* ## Keeping it flexible */}
    <h2 id="keeping-it-flexible" class="lg:mt-6">
      Keeping it flexible
    </h2>
    ...
    <a href="#only-supporting-one-way-actions">How do we design a universal interface</a>, serving a wide range of brands and actions?
...
<Section title="Tradeoffs">
  ...
  <SubSection
    images={[
      { 
        src: "/work/formie/tradeoffs/no-editing/callout.png", 
        alt: "Callout in editor preview",
      },
      { 
        src: "/work/formie/tradeoffs/no-editing/one-time-message.png", 
        alt: "One-time notice on list page",
      },
      { 
        src: "/work/formie/tradeoffs/no-editing/original-plan.png", 
        alt: "Sketch for original solution",
      },
      { 
        src: "/work/formie/tradeoffs/no-editing/new-plan.png", 
        alt: "Plan for new solution",
      },
    ]}
    isUsingCarouselle={true}
    hasDoubleMargin={true}
  >
