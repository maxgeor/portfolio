    ...
    },
    {
      ...
      subsections:
        [
          ...
          { title: "Only customizing the title + description" },
...
<Section title="tldr">
  <table class="text-sm flex flex-col w-full transition-all ease-out duration-150 " cellspacing="0" cellpadding="0">
    <tr>
      <td class="w-4 pr-2 pb-5"><p>Problem</p></td>
      <td class="pl-0 sm:pl-6"><p class="pb-5">Etherscan’s frontend sucked</p></td>
    </tr>
    <tr>
      <td class="w-4 pr-2 pb-5"><p>Solution</p></td>
      <td class="pl-0 sm:pl-6"><p class="pb-5">Airtable Forms, but for smart contract actions</p></td>
    </tr>
    <tr>
      <td class="w-4 pr-2 pb-5"><p>Decisions</p></td>
      <td class="pl-0 sm:pl-6">
        <ul>
          <li class="relative block before:absolute before:-left-[22px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pl-0 pb-1">Every action has their own page</li>
          <li class="relative block before:absolute before:-left-[22px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pl-0 pb-1">Only supported one-way actions (two-ways were annoying and not important)</li>
          <li class="relative block before:absolute before:-left-[22px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pl-0 pb-1">Open text form title and description open text (so any action could make sense)</li>
          <li class="relative block before:absolute before:-left-[22px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pl-0 pb-5">Made people confirm trust before submitting to deter scammers</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td class="w-4 pr-2 pb-5"><p>Tradeoffs</p></td>
      <td class="pl-0 sm:pl-6">
        <ul>
          <li class="relative block before:absolute before:-left-[22px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pl-0  pb-1">Cut editing, let people make unlimited forms instead</li>
  ...
  - Solution: Google Forms, but for smart contract actions
  - Decisions:
    - Every contract action on one page -> Every action has their own page
    - Only supported one-way actions because two-ways were annoying and not important 
    - Made form title and description open text so any action could make sense
    - Made people confirm trust before submitting to deter scammers
  - Tradeoffs:
...
<Section title="Research">
  <Section title="Most actions just need a form" isSubsection={true}>
    We started by studying what worked with Etherscan's interface. Their "frontend" was a list of forms. We were skeptical that a raw, unstyled form was the optimal layout for contract actions... but it turned out to be (kinda).

    <FootnoteParagraph>
      Turns out, **smart contract actions are super simple**<sup>1</sup>. Most only take 1-2 inputs and return little to no data. With little to manage, the form's focused, linear path makes it a great interface for easing people through the unfamiliar flow of calling contracts.
      <Footnote number={1}>
  ...
  <Section title="Projects sacrificed UX to save time" isSubsection={true}>
    ...
    Everyone I talked to was painfully aware of how bad the interface was. Even though projects couldn't justify making something custom, they still valued UX. Given a better option with easy setup, we believed they'd switch to something else.
...
<Section title="Idea">
  ...
  We could make huge UX improvements by...
    ...
    - [Letting people write copy](#letting-people-write-their-own-title-and-description) to give context
  ...
  2. Everyone has used Google or Airtable Forms before. Giving contracts a similar structure makes them universally intuitive.
...
<Section title="Key Decisions">
  ...
  <Section title="Only supporting one-way actions" isSubsection={true}>
    ...
    We couldn't create a great interface for two-way methods, so we decided to focusing on our core usecase by only supportting one-way actions.
  ...
  <Section title="Letting people write their own title and description" isSubsection={true}>
    ...
    But it wasn’t enough. Every action needed something explained that static language couldn’t cover. To guarentee that any action could be understood, we let people write their own title and description. It's a simple but effective way to keep forms flexible without adding complexity.
  ...
  <Section title="Making people confirm trust" isSubsection={true}>
    We couldn’t stop every scam or build a trustless, zero-proof protocol to do it. Instead, we detered scammers by making people confirm they trusted the form before submitting.
...
By [comparing to our baseline](https://basecamp.com/shapeup/3.5-chapter-14#compare-to-baseline), we cut some non-essential features:
  ...
  <Section title="Only customizing the title + description" isSubsection={true}>
