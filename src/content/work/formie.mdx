...
<Section title="One page, one action">
  ...
  >
    ...
    it's a mess! You end up like Indiana Jones — hacking through jungle and solving puzzles, with luck, to find the form you want.

    Linking straight to the form makes it impossible to miss.
