...
Etherscan puts every action in one place, but it's a mess! You end up like Indiana Jones, hacking through layers and solving puzzles to find the form you want (with luck).
