...
<Section title="Using human words">
  ...
  >
    The best way to communicate complicated ideas is explaining them in Plain English.

    On top if replaced words like "Method" and "Write" with "Action" and "Send", we **let people write their own title and description**.
