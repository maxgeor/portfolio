...
<Section title="One page, one action">
  <SubSection>
    ...
    Etherscan puts every actions in one place for your convience, but
    it's a mess! You end up cutting through jungle and solving puzzles
    like Indiana Jones to find the form you want — it's insanity!!

    Just give people a link to the form.

    No fuss. No muss. Just a form.
