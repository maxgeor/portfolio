...
1. _They used Etherscan as a “good enough” interface_. Teams would plug in their admin actions, while blockchain developers made it their UI for testing & personal projects (since they didn’t like writing frontend code).
