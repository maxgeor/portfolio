...
<Section title="tldr">
  <table class="text-sm leading-6 flex flex-col w-full transition-all ease-out duration-150 " cellspacing="0" cellpadding="0">
    <tr>
      <td class="w-4 pr-2 pb-3"><p>Problem</p></td>
      <td class="pl-0 sm:pl-6"><p class="pb-3">Etherscan’s frontend sucked.</p></td>
    </tr>
    <tr>
      <td class="w-4 pr-2 pb-3"><p>Solution</p></td>
      <td class="pl-0 sm:pl-6"><p class="pb-3">Airtable Forms, but for smart contract actions.</p></td>
    </tr>
    <tr>
      <td class="w-4 pr-2 pb-3"><p>Decisions</p></td>
      <td class="pl-0 sm:pl-6">
        <ul>
          <li class="relative block before:absolute before:-left-[17px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•']">
          ...
          <li class="relative block before:absolute before:-left-[17px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pb-3">
    ...
    <tr>
      <td class="w-4 pr-2 pb-3"><p>Tradeoffs</p></td>
      <td class="pl-0 sm:pl-6">
        <ul>
          <li class="relative block before:absolute before:-left-[17px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] ">
            Cut editing, let people make unlimited forms instead.
          </li>
          <li class="relative block before:absolute before:-left-[17px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pb-0">
