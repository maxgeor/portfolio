...
<Section title="Problem">
  ...
  >
    ...
    1. Writing code
    2. Uploading it to the blockchain as a `smart contract`
    3. Building a `frontend` (as an app or website) for the contract, so people can interact with it

    {/* To save time, blockchain developers use frontend generators. These take your code and give it a free, bare-bones UI. */}
    To save time, blockchain developers use frontend generators. These take your code and make a free, bare-bones UI for it.

    Etherscan is the biggest frontend generator, powering tons of projects.
    ...
    This frontend felt more like an obstacle course — we knew it could be better.
...
<Section title="Idea">
  ...
  >
    ...
    With this, we got our high-level solution: A form builder, like Google Forms, but for smart contracts.
...
<Section title="Challenges">
  <SubSection>
    ...
    We needed some way to deter scammers without making the product harder to build or use.
