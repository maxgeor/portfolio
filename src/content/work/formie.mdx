...
<Section title="Process">
  <SubSection hasImages={false}>
    <Fragment slot="text">
      We built Formie piece-by-piece. The project was broken into chunks of work,
      sequenced by unknowns & dependencies, then designed and
      implemented in order. 
      
      Instead of designing upfront, we designed as we built. I'd figure out the UI & flows with rough sketches, then skip Figma and jump right into the code.

      This made us faster to find big unknowns, make key decisions, and get to the right design.
    </Fragment>
