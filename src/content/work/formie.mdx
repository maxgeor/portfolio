...
description: Personal project to make a simple, universal interface for smart contracts.
...
<details>
  <summary>Don't know what Etherscan is?</summary>

Etherscan is a place to explore all data on the blockchain.
