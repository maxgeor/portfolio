...
<Section title="Problem">
  <SubSection>
    <Fragment slot="text">
      Using Etherscan to call smart contracts _sucks_. Watching friends, Twitter, and myself stuggle made it's flow feel like an obstacle course:
      ...
      While Etherscan's UI-in-a-box proved to be a developer favorite, we knew it could be better.
    </Fragment>
...
<Section title="Scope">
  <SubSection hasImages={false}>
    <Fragment slot="text">
      Starting from scratch, our focus was shipping V1. We wanted to make something fast that was easy to change later. Putting speed first lead us to [trade off important but non-vital features](#tradeoffs) for an earlier launch.
      </Fragment>
    </SubSection>
  ...
  <SubSection hasImages={false}>
    <Fragment slot="text">
      - (Trust) Make sure people are informed enough to trust forms
        - Smart Contracts: Public code that's stored and run a blockchain.
          - Anyone see
      ...
      - (Communication) 
        - Communicate unique details & characteristics of interacting with smart contracts to non-technical users
        - How to make sure people are informed without being overwhelmed
        - Giving feedback ot users about what's happening behind the scenes after 
      - (Flexibility)
      ...
      ## Key Decisions
        ...
        - Form builder UI (communication)
          ...
          - **Custom title & description** (flexibility, communication)
...
<Section title="Key Decisions">
  <SubSection hasImages={false}>
    <Fragment slot="text">
      - Clear communication, (Facts > Education )
      ...
      - Only write methods
        ...
        - We focused only on one-way methods because...
        1. _They're neglected_: Plenty of tools exist for getting and displaying blockchian data (Dune, Etherscan, etc), but very few for  and b) they're simpler (only have).
      - Custom titles & descriptions
      - Trust confirmation
    </Fragment>
  </SubSection>
