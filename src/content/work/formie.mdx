    ...
    <tr>
      ...
      <td class="pl-0 sm:pl-6">
        <ul>
          ...
          <li class="relative block before:absolute before:-left-[22px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pl-0 ">Open text form title and description open text (so any action could make sense)</li>
          <li class="relative block before:absolute before:-left-[22px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pl-0 pb-4">Made people confirm trust before submitting (to deter scammers)</li>
        </ul>
      </td>
    </tr>
    <tr>
