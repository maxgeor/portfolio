...
<Section title="Research">
  <Section title="Most actions just need a form" isSubsection={true}>
    ...
    <FootnoteParagraph>
      Turns out, **smart contract actions are extremely simple**<sup>1</sup> — most only take 1-2 inputs and return little to no data. Having only a few steps and elements, a form's focused, linear flow made it a great interface for easing people through the murky waters of calling contracts.
      <Footnote number={1}>
