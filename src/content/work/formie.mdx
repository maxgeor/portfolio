...
tldr: 
  [
    # "Personal project to make a better universal interface for smart contracts",
...
Formie got featured by the Milk Road and was picked as a top project from their Milk Money Cohort. While it was used by teams and developers, we put it on auto-pilot for a few reasons:

1. The product would have to get way more complex to support advanced usecases that wouldn't have moved the needle enough business-wise. 

got traction and was used by developers, we realized that many smart contract interfaces needed a custom solution.
