...
<Section title="Using human words">
  ...
  >
   To translate tricky ideas, explain them in Plain English.
    ...
    Adding it wasn't a trivial decision. The public, yet opaque nature of smart contracts lets bad actors use editable fields to misreprent actions.

    Despite its issues, open text was essential — we had to design around it.
