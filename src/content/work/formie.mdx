...
<Section title="Research">
  <Section title="Most actions just need a form" isSubsection={true}>
    ...
    <FootnoteParagraph>
      Turns out, **smart contract actions are extremely simple**<sup>1</sup> — most only take 1-2 inputs and return little to no data. Having only a few steps and elements, the form's focused, linear path makes it a great interface for easing people through the unfamiliar flow of calling contracts.
      <Footnote number={1}>
