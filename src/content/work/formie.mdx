...
<Section title="Only one-way actions">
  <SubSection>
    ...
    We decided to focus only on one-way actions — filtering out any two-ways when plugging in a contract. This radically simplified the product, letting a single interface give a consistenly great exprience.
