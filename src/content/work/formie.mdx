...
>
    ...
    1. Writing code
    2. Upload it to a blockchain
    3. Building a “frontend” for their code (an app or website), so people can use it

    To save time, blockchain developers use “frontend generators”. These take your code and give it a free, bare-bones UI.

    Etherscan is the most popular one, which lots of projects use.
    ...
    The tool felt like an obstacle course — we knew it could be better.
