...
<Section title="Research">
  <Section title="Most contract actions just need a form" isSubsection={true}>
    We started by studying what worked with Etherscan's interface. Their "frontend" was a list of forms for each `action` in a smart contract. We were sceptical that a raw, unstyled form was the best layout for these actions... but it was.
