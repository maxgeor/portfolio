...
import TldrSection from "../../components/prose/TldrSection.astro";
...
import FootnotedParagraph from "../../components/prose/FootnotedParagraph.astro";
...
## ~~Editing forms~~ Infinite forms  
{/* <h2 aria-label="Replacing editing with infinite forms">
  ~~Editing forms~~ Infinite forms
</h2> */}
...
<h2 aria-label="Only letting people customize their title & description">
  ~~Customize everything~~ Title + description
</h2>
...
<h2 aria-label="Limited error messaging">
  ~~Perfect~~ Limited error messaging
</h2>
