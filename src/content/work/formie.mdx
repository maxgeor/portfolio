...
<Section title="Process">
  ...
  >
    ...
    Design started with rough sketches. After breadboarding the flows and UI, I’d design the rest in code. While I designed, Hassan would build out the backend (I’d help later).
...
<Section title="Challenges">
  <SubSection>
    ...
    Smart contracts have tons of strange behavious:
