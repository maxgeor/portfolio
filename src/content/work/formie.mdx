...
<Section title="Problem">
  ...
  >
    ...
    The frontends felt more like an obstacle courses — we knew they could be better.
...
<Section title="Using human words">
  ...
  >
    ...
    Adding custom fields wasn't a trivial decision. With smart contracts being public, yet opaque, editable fields let bad actors misreprent one action as another.

    Having open text felt essential, so we had to design around it's misuse.
...
<Section title="Tradeoffs">
  <SubSection>
    ...
    By <a href="https://basecamp.com/shapeup/3.5-chapter-14#compare-to-baseline" target="_blank">comparing to baseline</a>, we cut important, but non-essential features:
