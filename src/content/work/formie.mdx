...
<Section title="Challenges">
  <SubSection>
    ...
    ## Keeping it flexible
    Because Formie can hook into any contract, it's copy, error handling, and layout need to accomodate _thousands_ of different actions.

    It also had to work with different brands. Formie acts as an extension of a project's interface. Sometimes, it _is_ the interface. A strong, noteworthy aestheic would clash with the project's brand — confusing users and turning projects away.
...
<Section title="Using human words">
  ...
  >
    ...
    Open text was an economical way to guarentee that any action could make sense and have the context it needed.

    Adding custom fields wasn't a trivial decision. With smart contracts being public, yet opaque, editable fields could let bad actors misreprent actions.

    Having open text was essential, so we had to design around the problem.
...
<Section title="Forcing people to confirm trust">
  ...
  >
    ...
    Most people who get scammed, especially in crypto, are in a rush. They see a link to a sick mint on Discord or Twitter, feel the FOMO, then act.

    Making people double check their source is a cheap way to protect users from scammers and themselves.
