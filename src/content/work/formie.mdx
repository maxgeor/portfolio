...
<Section title="Using human words">
  ...
  >
    ...
    But this wasn’t enough. Every action needed explanation that static language couldn’t cover. To make forms flexible, we let people customize their title and description. It was an effective way to ensure forms fit their actions without adding complexity.
