...
>
  <SubSection>
    ...
    Their frontend felt more like an obstacle course than a tool — we knew it could be better.
...
>
  <SubSection >
    ...
    1. _People used Etherscan as a "good enough" interface_. Teams used it for admin-like actions, while blockchain developers used it for personal projects & testing (since they preferred working in the backend).
    2. _Everyone knew Etherscan sucked_ (visually & functionally) but wasn't willing to invest the time & money to build something custom.
    ...
    - The bar was _really_ low — we had lots of room to <a class="anchor" href="#tradeoffs">cut scope</a> and still ship something better.
...
<Section title="Tradeoffs">
  ...
  <SubSection
    images={[
      { 
        ...
        alt: "Me editing other fields with prototype",
      },
      { 
  ...
  >
    ...
    Originally, I wanted every part of a form to be editable:
