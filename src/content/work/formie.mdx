...
<Section title="Idea">
  ...
  > 
    ...
    - Layers of irrelevant info buries <a href="#one-page-one-action">the UI that actually matters</a>
...
<Section title="Process">
  ...
  >
    ...
    3. _Etherscan was almost exclusively used for <a href="#only-supporting-one-way-actions">one-way actions</a>_ (two-way actions tended to have custom frontends).

    Takeaways:

    - One-way smart contract actions were neglected
    - People still valued UX and might be willing to switch if setup was easy
    - It the bar was _really_ low — we had lots of room to <a href="#tradeoffs">cut scope</a> and still ship something better.
...
<Section title="Challenges">
  ...
  >
    ...
    _<a href="#making-people-confirm-trust">How do we ward off scammers</a> without making the product harder to build or use?_
    ...
    _Which ideas are essential? <a href="#using-human-words">How do we explain things</a> without overwhelming people?_
...
<Section title="Key Decisions">
  ...
  >
    ...
    One-way actions are simple — all they need are some fields, a button, and a straightforward layout.
