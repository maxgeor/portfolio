...
<Section title="Key Decisions">
  ...
  >
    ...
    Two-way actions are complex. Different data needs different layouts, with non-blockchain data in the mix. These contraints require custom UI to make a great experience.
