...
<Section title="Research">
  ...
  <Section title="People love saving time, but not using Etherscan" isSubsection={true}>
    ...
    Despise picking Etherscan, teams & developers still valued UX. Given a better option with easy setup, we believed they'd switch. Plus, the bar was low, so we could [cut scope](#tradeoffs) and still be step up.
  </Section>
</Section>
