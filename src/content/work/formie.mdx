...
<Section title="Tradeoffs">
  ...
  >
    ...
    ## ❓ Editing
    I always wanted to let people edit their entire form. We realized deep into development that we'd have to change our backend to let people edit securely.

    Instead of delaying launch by 2 weeks, we tried to find annother approach.

    Our solution was...
    1. Only let people edit the form title and description
    2. Making forms permanent
    3. Let people make unlimited forms

    form title and description gives 80% of the benefits of editing (you can use both to give context to other parts of the form)

    This would let people make updates (by making new forms) while maintain form security, without changing the backend.



    This solution gave 80% of the benefits from editing in 15 minutes of work instead of 3 weeks.

    While this wasn't an ideal solution, it saved us 3 weeks of total work (building & designing the edit functionality and rebuilding the backend)
