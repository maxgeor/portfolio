...
<Section title="Challenges">
  <SubSection>
    ...
    There are tons of strange facts & behavious behaviours around smart contracts:
    ...
    Formie also had to work with different brands. Formie acts as an extension of a project's interface. Sometimes, it _is_ the interface. A strong, noteworthy aestheic would clash with the project's brand — confusing users and turning projects away.
...
<Section title="Human words">
  <SubSection>
    Not only do we replace the techno-bable with plain english, but let people write the words themselves! no better way to ensure the right info is on any given form that to let form makers put them there!
...
<Section title='"Yes, I trust this form"'>
  <SubSection>
    Our solution to ward off spammers was forcing people to confirm that they trust the form before letting them submit.

    - Detecting spammers isn't rocket science. Most people who get scammed, especially in crypto, are in a rush. They see a link to a sick mint on Discord or Twitter and act out of FOMO. Often, double checking the source or asking a friend is enough to sniff out a scam. Adding a little fiction is enough to save most people from scams (and also covers Formie legally).
    - Easy to build

    Extra friction is worth saving someon
