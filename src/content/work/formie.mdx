...
<Section title="Problem">
  ...
  >
    ...
    <hr class="h-px border-t border-gray-300/90 border-dashed my-0.5"></hr>
...
<Section title="Challenges">
  ...
  >
    ...
    _<a class="anchor" href="#making-people-confirm-trust">How do we ward off scammers</a> without making the product harder to build or use?_
    ...
    _Which ideas are essential? <a class="anchor" href="#using-human-words">How do we explain things</a> without overwhelming people?_
    ...
    _<a href="#only-supporting-one-way-actions">How do you design a universal interface</a>, serving a wide range of brands and actions?_
...
<Section title="Key Decisions">
  ...
  >
    ...
    One-way actions are simple — all they need are some fields, a button, and a straightforward layout. Our research also found that <a class="anchor" href="#research">they're underserved</a> relative to other tooling.
...
<Section title="Tradeoffs">
  ...
  >
    ...
    Originally, wanted every part of a form to be editable. On top of the title and description, we wanted to let people customize...

    - Field titles, descriptions, placeholders
    - Error messages
    - Button label, and more.

    But, because we cut editing, all customization would happen on the form creation page. Making someone set all these options in one go would be overwhelming.

    To keep it simple, we decided to only allow the form's title and description to be customized. The open text fields existed to create clarity. The title & description could be used to clarify other parts of the form, so they could do 80% of the heavy lifting.
