  ...
  <table class="text-sm flex flex-col w-full transition-all ease-out duration-150 " cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td class="pl-0 sm:pl-6">
        <ul>
          <li class="relative block before:absolute before:-left-[22px] before:-top-0.5 before:rounded-full before:text-[24px] before:content-['•'] pl-0 pb-1">Every action gets its own page</li>
