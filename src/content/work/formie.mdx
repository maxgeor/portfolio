...
<Section title="Using human words">
  ...
  >
   To translate tricky ideas, explain them in Plain English.
    ...
    Open text fields were a cheap way to guarantee that actions made sense.

    Deciding to add them wasn't trivial: The public, yet opaque nature of smart contracts lets bad actors use freehand writing to misreprent actions.
