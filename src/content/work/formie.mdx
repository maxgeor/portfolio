...
{/* Need to talk about deciding on layout first because it informed other decisions */}
...
{/* Always display and link to data about the contract */}

{/* FORCED PEOPLE TO CONFIRM THEY TRUSTED THE FORM */}
{/* Letting people give their own context on forms was absolutely essential. */}
{/* but it created another problem: Letting people describe their own form would let people misrepresent one contract as another */}
{/* Even though we show */}

{/* ONE-WAY ACTIONS ONLY */}
{/* One-way actions only */}
