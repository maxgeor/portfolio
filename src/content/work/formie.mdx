  ...
  [
    ...
    { 
      ...
      subsections: [
        ...
        { title: "People love saving time, not using Etherscan" },
      ]
    },
    { title: "Idea" },
    { title: "Process" },
...
<Section title="Research">
  ...
  <Section title="People love saving time, not using Etherscan" isSubsection={true}>
    ...
    Everyone I talked to was painfully aware of how bad the interface was. Despite the problems, they couldn't justify a custom solution.
  
    But teams and developers still valued UX. Given a better option with easy setup, we believed they'd switch. Plus, the bar was low, so we could [cut scope](#tradeoffs) and still be step up.
  </Section>
</Section>
