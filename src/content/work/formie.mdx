...
<Section title="Only supporting one-way actions">
  <SubSection>
    Smart contract have two kinds of actions: 
...
<Section title="Using human words">
  <SubSection>
    Not only do we swap robot words like "Method" and "Write" for plain english, but let people write the words themselves! no better way to ensure the right info is on any given form that to let form makers put them there!
...
<Section title="Force people to confirm trust">
  <SubSection>
