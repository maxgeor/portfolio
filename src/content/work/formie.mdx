...
import Block from "../../components/prose/Block.astro";
import Image from "../../components/prose/Image.astro";
import Text from "../../components/prose/Text.astro";
import Heading from "../../components/prose/Heading.astro";
import Section from "../../components/prose/Section.astro";
import SectionContent from "../../components/prose/SectionContent.astro";

<Section title="Problem">
  <div slot="text" class="flex flex-col gap-y-6">
  ...
  <div slot="images" class="flex flex-col gap-y-6">
    <Image
...
<Section>
  <Heading slot="title">Finding the form</Heading>
  <Block slot="text" span="col-span-full lg:col-start-3 lg:col-end-7">
    <Text>
    ...
    <Text>
      This made it clear that the most intuitive design would be similar to
