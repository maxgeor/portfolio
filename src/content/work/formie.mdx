...
<Section title="Using human words">
  ...
  >
   To translate tricky ideas, explain them in Plain English.
    ...
    Open text was an economical way to guarentee that any action could be understood, but adding it wasn't a trivial decision. The public, yet opaque nature of smart contracts lets bad actors use editable fields to misreprent actions.
