...
<Section title="Only supporting one-way actions">
  ...
  >
    ...
    Two-way actions are complex. Different data needs different layouts, with non-blockchain data getting mixed in. To make a great experience, you need a custom UI.
