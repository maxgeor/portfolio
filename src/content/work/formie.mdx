...
<Section title="Idea">
  <SubSection>
    We realized that smart contract actions were just mini forms: a few fields and a button that does something when submitted. 
    
    Why weren't we treating these actions like any other form? What couldn't each of these actions have thier own page? What if we made a tool that made these forms?
