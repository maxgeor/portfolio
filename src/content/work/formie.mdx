...
>
  <SubSection >
    ...
    2. _They used Etherscan for <a class="anchor" href="#only-supporting-one-way-actions">one-way actions</a>_ (code that triggers a change). Two-way actions almost always had their own frontend.
