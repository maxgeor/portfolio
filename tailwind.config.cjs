...
module.exports = {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				sm: '0px 1px 1px -1px rgba(0,0,0,.045), 0px 2px 2px -1px rgba(0,0,0,.045), 0px 0px 0px 1px rgba(0,0,0,.069)',
				DEFAULT: '0px 1px 1px -1px rgba(0,0,0,.1), 0px 2px 2px -1px rgba(0,0,0,.1), 0px 0px 0px 1px rgba(0,0,0,.08)',
